常见错误
http://blog.csdn.net/gzejia/article/details/51330663
<br/>
1)Gradle Plugin的版本降低至1.2.3
<br/>
2)app底下的build.gradle中加入multiDexEnabled true
...
<br/>
3)terminal中set ANDROID_HOME=D:\个人SDK根目录
<br/>
4)具体是由于什么原因照成的小编也不是很清楚，只是在测试中发现HTC6.0.1与MEIZU5.1的手机存在该情况。最终的解决方案是将app下bulid.gardle当中的targetSdkVersion值修改为22就可以了
<br/>
5)mac:./gradlew clean nuwaQihooDebugPatch -P NuwaDir=/Users/jason/Documents/nuwa
<br/>
  win:gradlew.bat clean nuwaQihooDebugPatch -P NuwaDir=/Users/jason/Documents/nuwa
<br/>
